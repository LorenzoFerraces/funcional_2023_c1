...
/* package testCabal-0.1.0.0 */
#ifndef VERSION_testCabal
#define VERSION_testCabal "0.1.0.0"
#endif /* VERSION_testCabal */
#ifndef MIN_VERSION_testCabal
#define MIN_VERSION_testCabal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_testCabal */
...
#define CURRENT_COMPONENT_ID "testCabal-0.1.0.0-inplace-testCabal"
